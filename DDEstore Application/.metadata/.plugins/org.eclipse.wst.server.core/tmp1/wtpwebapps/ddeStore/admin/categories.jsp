...
<%
    ...
    // Obține lista de categorii transmisă de servlet
        ...
        <div class="content flex-grow-1 p-4">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2>Categorii</h2>
                    <a href="/ddeStore/admin/addCategory.jsp" class="btn btn-primary">
                ...
                <table class="table table-striped">
                    ...
                    %>
                        <tr>
                            <td colspan="3" class="text-center">Eroare: Lista categoriilor este NULL.</td>
                        </tr>
                    <%
                        } else if (categories.isEmpty()) {
                    %>
                        <tr>
                            <td colspan="3" class="text-center">Nu exista categorii disponibile.</td>
                        </tr>
                    <%
                        } else {
                    ...
                    %>
                        <tr>
                            <!-- <td><%= category.get("ID_Categorie") %></td>-->
                            <td><%= category.get("NumeCategorie") %></td>
                            <td>
                                <a href="/ddeStore/admin/editCategory.jsp?id=<%= category.get("ID_Categorie") %>&name=<%= category.get("NumeCategorie") %>" class="btn btn-warning btn-sm">
                                	<svg xmlns="http://www.w3.org/2000/svg" style="width:20px; heigh:20px" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
									  <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
									</svg>
                                	Edit
                                </a>
                                <form action="/ddeStore/CategoryServlet" method="post" style="display: inline;">
                                    <input type="hidden" name="action" value="delete">
                                    <input type="hidden" name="categoryId" value="<%= category.get("ID_Categorie") %>">
