 ...
 * Generated at: 2024-12-30 14:52:46 UTC
...
public final class favorites_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    List<Map<String, String>> favoriteProducts = (List<Map<String, String>>) request.getAttribute("favoriteProducts");
      ...
      out.write("    <title>Lista Favorite</title>\r\n");
      ...
      out.write("		    background-color: #4caf50; /* Verde pentru succes */\r\n");
      ...
      out.write("			        <h2 class=\" mb-4\">Lista Favorite</h2>\r\n");
      out.write("			        <div class=\"row\">\r\n");
      out.write("			            ");
 ...
 for (Map<String, String> product : favoriteProducts) { 
      out.write("\r\n");
      out.write("			                    <div class=\"col-md-4\" data-product-id=\"");
      out.print( product.get("id") );
      out.write("\">\r\n");
      out.write("								    <div class=\"card mb-4\">\r\n");
      out.write("								        <img src=\"");
      out.print( product.get("image") );
      out.write("\" class=\"card-img-top\" alt=\"Produs\">\r\n");
      ...
      out.write("</h5>\r\n");
      out.write("								            <p class=\"card-text\">Pret: ");
      out.print( product.get("price") );
      out.write(" Lei</p>\r\n");
      out.write("								            <button class=\"btn btn-danger d-flex justify-content-center align-items-center p-2 rounded-circle\" \r\n");
      out.write("								            		onclick=\"removeFavorite('");
      out.print( product.get("id") );
      out.write("')\"\r\n");
      ...
      out.write("\r\n");
      out.write("			                <p class=\"text-center\">Nu exista produse in lista de favorite.</p>\r\n");
      out.write("			            ");
 } 
      out.write("\r\n");
      out.write("			        </div>\r\n");
      ...
      out.write("	\r\n");
      out.write("	<script>\r\n");
      out.write("		function removeFavorite(productId) {\r\n");
      out.write("		    const formData = new URLSearchParams();\r\n");
      out.write("		    formData.append(\"action\", \"remove\"); // AdaugÄ acÈiunea de eliminare\r\n");
      ...
      out.write("		            // Remove the card from the UI\r\n");
      out.write("		            const productCard = document.querySelector(`[data-product-id='");
      ...
      out.write("']`);\r\n");
      out.write("		            if (productCard) {\r\n");
      out.write("		                productCard.remove();\r\n");
      out.write("		            }\r\n");
      out.write("		            showPopup(data.message || \"Produs eliminat din favorite.\", \"success\");\r\n");
      out.write("		        } else {\r\n");
      out.write("		            showPopup(data.message || \"Eroare la eliminarea produsului.\", \"error\");\r\n");
      out.write("		        }\r\n");
      out.write("		    })\r\n");
      out.write("		    .catch(error => {\r\n");
      out.write("		        console.error(\"Eroare:\", error);\r\n");
      out.write("		        showPopup(\"A apÄrut o eroare la server. ÃncercaÈi din nou.\", \"error\");\r\n");
      out.write("		    });\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		function showPopup(message, type) {\r\n");
